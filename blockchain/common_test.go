...
// floutil.Block.  This is largely borrowed from the test code in flodb.
func loadBlocks(filename string) (blocks []*floutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = floutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
