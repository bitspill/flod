...
func (c *Client) SubmitBlockAsync(block *floutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *floutil.Block, options *btcjson.SubmitBlockOptions) error {
