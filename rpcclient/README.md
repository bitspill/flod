...
* [flod Websockets Example](https://github.com/bitspill/flod/tree/master/rpcclient/examples/flodwebsockets)
  ...
  block count
* [btcwallet Websockets Example](https://github.com/bitspill/flod/tree/master/rpcclient/examples/btcwalletwebsockets)
...
* Supports Websockets (flod/btcwallet) and HTTP POST mode (bitcoin core)
* Provides callback and registration functions for flod/btcwallet notifications
