...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bitspill/flod/peer)
...
```bash
$ go get -u github.com/bitspill/flod/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/bitspill/flod/peer#example-package--NewOutboundPeer)
