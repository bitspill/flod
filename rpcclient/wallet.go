...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []floutil.Address) ([]btcjson.ListUnspentResult, error) {
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []floutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
func (c *Client) ValidateAddress(address floutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
