...
func (h *BlockHeader) BlockPoWHash() chainhash.Hash {
	...
	return chainhash.Scrypt_1024_1_1_256(buf.Bytes())
}
...
func (h *BlockHeader) Flodecode(r io.Reader, pver uint32, enc MessageEncoding) error {
...
func (h *BlockHeader) FloEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
