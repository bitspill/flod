...
func isPubKey(script []byte) (bool, []byte) {
	...
	if len(script) == 35 && script[0] == txscript.OP_DATA_33 &&
		...
		_, err := floec.ParsePubKey(serializedPubKey, floec.S256())
		if err == nil {
...
func decompressScript(compressedPkScript []byte, version int32) []byte {
	...
	case cstPayToPubKeyUncomp4, cstPayToPubKeyUncomp5:
		...
		key, err := floec.ParsePubKey(compressedKey, floec.S256())
		if err != nil {
			return nil
		}
...
// of 0.1 FLO which is 10000000 satoshi.  Encoding 10000000 as a VLQ would take
...
//            0 (1) -> 0        (1)           *  0.00000000 FLO
//         1000 (2) -> 4        (1)           *  0.00001000 FLO
//        10000 (2) -> 5        (1)           *  0.00010000 FLO
//     12345678 (4) -> 111111101(4)           *  0.12345678 FLO
//     50000000 (4) -> 47       (1)           *  0.50000000 FLO
//    100000000 (4) -> 9        (1)           *  1.00000000 FLO
//    500000000 (5) -> 49       (1)           *  5.00000000 FLO
//   1000000000 (5) -> 10       (1)           * 10.00000000 FLO
// -----------------------------------------------------------------------------
