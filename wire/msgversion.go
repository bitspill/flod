...
const DefaultUserAgent = "/flowire:0.5.0/"
...
func (msg *MsgVersion) Flodecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	buf, ok := r.(*bytes.Buffer)
	if !ok {
		return fmt.Errorf("MsgVersion.Flodecode reader is not a " +
			"*bytes.Buffer")
	}
...
// This is part of the Message interface implementation.
func (msg *MsgVersion) FloEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
