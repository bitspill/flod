...
func TestFeeFilterLatest(t *testing.T) {
	...
	err := msg.FloEncode(&buf, pver, BaseEncoding)
	if err != nil {
	...
	err = readmsg.Flodecode(&buf, pver, BaseEncoding)
	if err != nil {
...
func TestFeeFilterWire(t *testing.T) {
	...
	for i, test := range tests {
		...
		var buf bytes.Buffer
		err := test.in.FloEncode(&buf, test.pver, BaseEncoding)
		if err != nil {
		...
		err = msg.Flodecode(rbuf, test.pver, BaseEncoding)
		if err != nil {
...
func TestFeeFilterWireErrors(t *testing.T) {
	...
	for i, test := range tests {
		...
		err := test.in.FloEncode(w, test.pver, BaseEncoding)
		...
		err = msg.Flodecode(r, test.pver, BaseEncoding)
