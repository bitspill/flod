...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*floutil.Block, error) {
	...
	blocks := make([]*floutil.Block, 0, 256)
	genesis := floutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
