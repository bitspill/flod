...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bitspill/flod/mining/cpuminer)
...
```bash
$ go get -u github.com/bitspill/flod/mining/cpuminer
```
