...
func (view *UtxoViewpoint) AddTxOuts(tx *floutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *floutil.Tx, blockHeight int32, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *floutil.Block, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(block *floutil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *floutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *floutil.Tx) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
