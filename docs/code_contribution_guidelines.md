...
reason, the flod suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire flod
...
One of the major design goals of all core flod packages is to aim for complete
...
commits](https://github.com/bitspill/flod/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into flod.
...
Rejoice as you will now be listed as a [contributor](https://github.com/bitspill/flod/graphs/contributors)!
...
[ISC license](https://github.com/bitspill/flod/blob/master/LICENSE).  This is
the same license as all of the code in the flod suite.
