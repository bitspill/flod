...
func (s *SigCache) Exists(sigHash chainhash.Hash, sig *floec.Signature, pubKey *floec.PublicKey) bool {
	s.RLock()
...
func (s *SigCache) Add(sigHash chainhash.Hash, sig *floec.Signature, pubKey *floec.PublicKey) {
	s.Lock()
	defer s.Unlock()
