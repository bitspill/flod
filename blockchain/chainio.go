...
// txouts.
func dbFetchSpendJournalEntry(dbTx database.Tx, block *floutil.Block, view *UtxoViewpoint) ([]spentTxOut, error) {
...
func (b *BlockChain) createChainState() error {
	...
	genesisBlock := floutil.NewBlock(b.chainParams.GenesisBlock)
...
func (b *BlockChain) initChainState() error {
	...
	return b.db.View(func(dbTx database.Tx) error {
		...
		blockWeight := uint64(GetBlockWeight(floutil.NewBlock(&block)))
...
// raw block for the provided node, deserialize it, and return a floutil.Block
// with the height set.
func dbFetchBlockByNode(dbTx database.Tx, node *blockNode) (*floutil.Block, error) {
	...
	block, err := floutil.NewBlockFromBytes(blockBytes)
	if err != nil {
		return nil, err
	}
...
func dbStoreBlock(dbTx database.Tx, block *floutil.Block) error {
...
func (b *BlockChain) BlockByHeight(blockHeight int32) (*floutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*floutil.Block, error) {
