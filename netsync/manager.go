...
import (
	...
	peerpkg "github.com/bitspill/flod/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*floutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *floutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *floutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *floutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
