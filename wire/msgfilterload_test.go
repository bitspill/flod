...
func TestFilterLoadCrossProtocol(t *testing.T) {
	...
	var buf bytes.Buffer
	err := msg.FloEncode(&buf, ProtocolVersion, BaseEncoding)
	if err != nil {
	...
	err = readmsg.Flodecode(&buf, BIP0031Version, BaseEncoding)
	if err == nil {
...
func TestFilterLoadMaxFilterSize(t *testing.T) {
	...
	err = msg.Flodecode(readbuf, ProtocolVersion, BaseEncoding)
	if err == nil {
